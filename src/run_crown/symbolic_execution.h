...
public:
    ...
    const vector<SymbolicExpr *> & exprs() const {return exprs_;}
    ...
    const vector<SymbolicExpr *> * mutable_exprs() const {return & exprs_;}
	vector<Value_t>* mutable_inputs() { return &inputs_; }
	SymbolicPath* mutable_path() { return &path_; }
	ObjectTracker* object_tracker() {return &object_tracker_;}
